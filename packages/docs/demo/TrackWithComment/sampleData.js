export default {
  ...
  selection: { type: 'text', anchor: 378, head: 378 },
  track: {
    commits: [
      {
        id: 0,
        data: { username: 'Anonymous user', userid: '12345' },
        time: '2019-10-05T11:39:44.876Z',
        steps: [[1, 1, 586]],
        maps: [[1, 0, 585]],
      },
      {
  ...
  comment: {
    comments: [
      {
        id: '8ea08716-0ba7-4fb2-8676-b97aff1a5d41',
        data: {
        ...
        status: 'NEW',
        time: '2019-08-09T04:32:06.248Z',
        start: 3736,
        end: 0,
      },
      {
        id: 'a33379e5-64e3-43aa-8e4d-317115027b4d',
        data: {
          message: 'This is comment number: 2',
          userid: '12345',
          username: 'Anonymous user',
        },
        status: 'NEW',
        time: '2019-08-09T04:32:20.461Z',
        start: 3736,
        end: 0,
      },
      {
        id: '50460642-74a9-4090-8ba3-201c78a2de0d',
        data: {
          message: 'I do not understand this text :(',
          userid: '12345',
          username: 'Anonymous user',
        },
        status: 'NEW',
        time: '2019-09-29T14:09:24.868Z',
        start: 1,
        end: 160,
      },
      {
        ...
        data: {
          message: 'This text is bit confusing, but I enjoy the reading.',
          userid: '00000',
          username: 'Test user',
        },
        status: 'RESOLVED',
        ...
        replies: [
          {
            id: '9d44b198-4fb7-4962-99d5-bd17a757527a',
            data: {
              message: 'Hey, that sounds great !',
              userid: '12345',
              username: 'Anonymous user',
            },
          },
      ...
      {
        id: 'a90cfee1-57b0-4cf8-bd45-9f9745f44c5b',
        data: {
          message: 'Comment at bottom ... oooppppps',
          userid: '12345',
          username: 'Anonymous user',
        },
        status: 'NEW',
        time: '2019-09-29T14:10:07.798Z',
        start: 1736,
        end: 1929,
      },
      {
        ...
        data: {
          message: 'I like this editor sooooooo much.',
          userid: '00000',
          username: 'Test user',
        },
        status: 'NEW',
        ...
        replies: [
          {
            id: '436b10d3-88da-41c9-96c8-ecc4516a42b2',
            data: {
      ...
      {
        id: '6d728649-b9f2-44fa-bed7-e9fd6c9b52ca',
        data: {
          message: 'The last quote...',
          userid: '12345',
          username: 'Anonymous user',
        },
        status: 'NEW',
        time: '2019-09-29T14:10:35.121Z',
        start: 3187,
        end: 3422,
      },
    ],
