Editor with feature to track and revert the changes, enter `cmd-s` or click `Save` button to save the chamges in editor. Click an area in editor or hover a commit record below to highlight the change.
<br />
<br />
